...
class DataCleaner:
    ...
    def _find_matching_answer(self, question: str, answers: List[str]) -> Optional[str]:
        ...
        for answer in answers:
            ...
            # 检查是否需要客户提供信息（使用正则表达式严格匹配）
            if any(re.search(pattern, answer) for pattern in [
                # 基本请求模式
                r'^请(?:您)?(?:提供|发|上传|提交|填写|补充|出示|出示一下|出示您的|出示下|出示下您的|出示一下您的)',
                r'^麻烦(?:您)?(?:提供|发|上传|提交|填写|补充|出示|出示一下|出示您的|出示下|出示下您的|出示一下您的)',
                r'^能否(?:您)?(?:提供|发|上传|提交|填写|补充|出示|出示一下|出示您的|出示下|出示下您的|出示一下您的)',
                r'^可以(?:您)?(?:提供|发|上传|提交|填写|补充|出示|出示一下|出示您的|出示下|出示下您的|出示一下您的)',
                r'^需要(?:您)?(?:提供|发|上传|提交|填写|补充|出示|出示一下|出示您的|出示下|出示下您的|出示一下您的)',
                
                # 把/将模式
                r'^请(?:您)?(?:把|将|发送|分享|出示|出示一下|出示您的|出示下|出示下您的|出示一下您的)',
                r'^麻烦(?:您)?(?:把|将|发送|分享|出示|出示一下|出示您的|出示下|出示下您的|出示一下您的)',
                r'^能否(?:您)?(?:把|将|发送|分享|出示|出示一下|出示您的|出示下|出示下您的|出示一下您的)',
                r'^可以(?:您)?(?:把|将|发送|分享|出示|出示一下|出示您的|出示下|出示下您的|出示一下您的)',
                r'^需要(?:您)?(?:把|将|发送|分享|出示|出示一下|出示您的|出示下|出示下您的|出示一下您的)',
                
                # 请您模式
                r'^请您(?:提供|发|上传|提交|填写|补充|把|将|发送|分享|出示|出示一下|出示您的|出示下|出示下您的|出示一下您的)',
                r'^麻烦您(?:提供|发|上传|提交|填写|补充|把|将|发送|分享|出示|出示一下|出示您的|出示下|出示下您的|出示一下您的)',
                r'^能否请您(?:提供|发|上传|提交|填写|补充|把|将|发送|分享|出示|出示一下|出示您的|出示下|出示下您的|出示一下您的)',
                r'^可以请您(?:提供|发|上传|提交|填写|补充|把|将|发送|分享|出示|出示一下|出示您的|出示下|出示下您的|出示一下您的)',
                r'^需要您(?:提供|发|上传|提交|填写|补充|把|将|发送|分享|出示|出示一下|出示您的|出示下|出示下您的|出示一下您的)',
                
                # 把/将您的模式
                r'^请(?:您)?把(?:您的)?(?:截图|照片|图片|凭证|单据|证明|材料|资料|信息|数据|记录|日志|文件|文档)',
                r'^请(?:您)?将(?:您的)?(?:截图|照片|图片|凭证|单据|证明|材料|资料|信息|数据|记录|日志|文件|文档)',
                r'^请(?:您)?发送(?:您的)?(?:截图|照片|图片|凭证|单据|证明|材料|资料|信息|数据|记录|日志|文件|文档)',
                r'^请(?:您)?分享(?:您的)?(?:截图|照片|图片|凭证|单据|证明|材料|资料|信息|数据|记录|日志|文件|文档)',
                r'^请(?:您)?出示(?:您的)?(?:截图|照片|图片|凭证|单据|证明|材料|资料|信息|数据|记录|日志|文件|文档)',
                
                # 其他常见模式
                r'^请(?:您)?(?:截图|照片|图片|凭证|单据|证明|材料|资料|信息|数据|记录|日志|文件|文档)',
                r'^麻烦(?:您)?(?:截图|照片|图片|凭证|单据|证明|材料|资料|信息|数据|记录|日志|文件|文档)',
                r'^能否(?:您)?(?:截图|照片|图片|凭证|单据|证明|材料|资料|信息|数据|记录|日志|文件|文档)',
                r'^可以(?:您)?(?:截图|照片|图片|凭证|单据|证明|材料|资料|信息|数据|记录|日志|文件|文档)',
                r'^需要(?:您)?(?:截图|照片|图片|凭证|单据|证明|材料|资料|信息|数据|记录|日志|文件|文档)',
                
                # 特殊模式
                r'^请(?:您)?(?:发|发送|分享|出示)(?:一下|下)?(?:您的)?(?:截图|照片|图片|凭证|单据|证明|材料|资料|信息|数据|记录|日志|文件|文档)',
                r'^麻烦(?:您)?(?:发|发送|分享|出示)(?:一下|下)?(?:您的)?(?:截图|照片|图片|凭证|单据|证明|材料|资料|信息|数据|记录|日志|文件|文档)',
                r'^能否(?:您)?(?:发|发送|分享|出示)(?:一下|下)?(?:您的)?(?:截图|照片|图片|凭证|单据|证明|材料|资料|信息|数据|记录|日志|文件|文档)',
                r'^可以(?:您)?(?:发|发送|分享|出示)(?:一下|下)?(?:您的)?(?:截图|照片|图片|凭证|单据|证明|材料|资料|信息|数据|记录|日志|文件|文档)',
                r'^需要(?:您)?(?:发|发送|分享|出示)(?:一下|下)?(?:您的)?(?:截图|照片|图片|凭证|单据|证明|材料|资料|信息|数据|记录|日志|文件|文档)',
                
                # 新增：匹配任何包含"请提供"、"请您提供"、"请发"、"请您发"等开头的句子
                r'^请(?:您)?(?:提供|发|上传|提交|填写|补充|出示|出示一下|出示您的|出示下|出示下您的|出示一下您的).*',
                r'^麻烦(?:您)?(?:提供|发|上传|提交|填写|补充|出示|出示一下|出示您的|出示下|出示下您的|出示一下您的).*',
                r'^能否(?:您)?(?:提供|发|上传|提交|填写|补充|出示|出示一下|出示您的|出示下|出示下您的|出示一下您的).*',
                r'^可以(?:您)?(?:提供|发|上传|提交|填写|补充|出示|出示一下|出示您的|出示下|出示下您的|出示一下您的).*',
                ...
                # 新增：匹配任何包含"截图"、"照片"、"图片"、"凭证"等关键词的句子
                r'.*?(?:截图|照片|图片|凭证|单据|证明|材料|资料|信息|数据|记录|日志|文件|文档).*?',
                
                # 新增：匹配任何包含"提供"、"发"、"上传"、"提交"等关键词的句子
                r'.*?(?:提供|发|上传|提交|填写|补充|出示|出示一下|出示您的|出示下|出示下您的|出示一下您的).*?',
                
                # 新增：匹配任何包含"把"、"将"、"发送"、"分享"等关键词的句子
                r'.*?(?:把|将|发送|分享|出示|出示一下|出示您的|出示下|出示下您的|出示一下您的).*?'
            ]):
                continue
